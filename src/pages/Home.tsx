      ...
      <section className="md:grid md:grid-cols-2 flex flex-col p-4 gap-3 items-center">
        ...
        <div className="bg-green-600 text-white text-center p-2">
          ...
          <h4 className="font-bold mt-3 p-6">
            ...
            visitantes em clientes ou leads qualificados. Com um design e
            conteúdo eficazes, a Landing Page pode influenciar os usuários a
            realizar a ação desejada, seja preenchendo um formulário, efetuando
            uma compra ou entrando em contato. <br />
            Adicionalmente, uma Landing Page proporciona uma oportunidade única
            para medir e analisar o desempenho de uma campanha, permitindo
            ajustes para otimizar o retorno sobre o investimento. Em síntese,
            uma Landing Page bem elaborada é um componente crucial para o êxito
